...
public class LienActivity extends Activity{
        ...
        public ImageButton butFacebook;
        public ImageButton butMinistere;
        public ImageButton butGendarmerie;
        ...
        public  ButtonListennerLiens buttonListennerLiens;
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            ArrayAdapter<String> adapter = new ArrayAdapter<String> (this, R.layout.items_list_evenements, ItemsList);


            //recuperation de la liste
            ListView listeDesFiches = (ListView)findViewById(R.id.listViewEvenements);
    ...
    public void init(){
        ...
        butFacebook = (ImageButton)findViewById(R.id.facebook);
        butMinistere = (ImageButton)findViewById(R.id.ministereInterieur);
        butGendarmerie= (ImageButton)findViewById(R.id.gendarmerieNational);


        buttonListennerLiens = new ButtonListennerLiens(this);
    ...
    public void createWidget(){
        ...
        butFacebook.setOnClickListener(buttonListennerLiens);
        butMinistere.setOnClickListener(buttonListennerLiens);
        butGendarmerie.setOnClickListener(buttonListennerLiens);
